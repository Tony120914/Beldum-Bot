...
| //report | Show a user how to report a bug if they find one. <br/><br/> (Join my [support server](https://discord.gg/V4w4Bxu) and report it there! <br/><br/> Or create a [GitHub issue](https://github.com/Tony120914/Beldum-Bot/issues).) | <img src="https://github.com/Tony120914/Beldum-Bot/blob/master/screenshots/report.JPG?raw=true" width="300"> |
