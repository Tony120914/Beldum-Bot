...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const embed = new MessageEmbed()
      ...
      .setDescription(`Currently in ${server_count} servers!`)
      ...
      .addField('Want to support/buy me a coffee?', `I have a [Ko-fi](https://ko-fi.com/toeknee). (But don't feel pressured to donate, I will keep the bot up regardless.)`, false)
